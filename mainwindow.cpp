    ...
    ui(new Ui::MainWindow)
{
    ...
    //ui->TableauPrincipal
    /*
    dock1->setMaximumSize(200, this->width()/3);
    dock2->setMaximumSize(200, this->width()/3);
    dock3->setMaximumSize(200, this->width()/3);
    dock4->setMaximumSize((this->height()-200)/2, 200);
    dock5->setMaximumSize((this->height()-200)/2, 200);*/
}
